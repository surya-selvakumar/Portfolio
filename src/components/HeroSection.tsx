    ...
    >
      ...
      <div className="section-container flex flex-col lg:flex-row items-center justify-between gap-10">
        <div className="flex flex-col max-w-xl space-y-6 text-center lg:text-left">
          ...
          >
            Designing future-ready systems that think, adapt, and deliver
          </motion.p>
          ...
          <div className="relative">
            ...
            >
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="text-xs text-gray-500">Python 3.12</div>
              </div>
              ...
              >
                ...
                <span className="text-gray-500">:</span>{" "}
                <span className="text-purple-600">'Surya Selvakumar'</span>
                <span className="text-gray-500">,</span>
              </motion.div>
              ...
              >
                ...
                <span className="text-gray-500">,</span>{" "}
                <span className="text-purple-600">'NLP'</span>
                <span className="text-gray-500">,</span>{" "}
                <span className="text-purple-600">'LLMs'</span>
                <span className="text-gray-500">,</span>{" "}
                <span className="text-purple-600">'AWS'</span>
                <span className="text-orange-500">]</span>
                <span className="text-gray-500">,</span>
              </motion.div>
              ...
              >
                <span className="text-green-600">'focuses'</span>
                <span className="text-gray-500">:</span>{" "}
                <span className="text-orange-500">[</span>
                <span className="text-purple-600">'AI Innovation'</span>
                <span className="text-gray-500">,</span>{" "}
                <span className="text-purple-600">'Real-world ML Solutions'</span>
                <span className="text-orange-500">]</span>
                <span className="text-gray-500">,</span>
              </motion.div>
